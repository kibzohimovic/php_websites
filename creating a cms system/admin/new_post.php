            ...
            <form action="new_post.php" class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select id="category" name="category" id="category" class="form-control" required>
                        ...
                        while ($rows = mysqli_fetch_assoc($run_sql)) {
                            if ($rows['category_name'] == 'home') { //the reason we are doing this is to ignore the home category in our database
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" cols="30" rows="3"></textarea> <!--The required attribute can't work coz of the javascript in the tiny mce editor-->
