<!--all this was got from the index.php-->
    ...
    <div class="container">
        ...
        <article class="row">
            ...
            <section class="col-lg-8">
                ...
                <?php
                $sel_sql = "SELECT * FROM posts WHERE category = '$_GET[cat_name]'"; //we want each post to be displayed as if on its own kind of page
